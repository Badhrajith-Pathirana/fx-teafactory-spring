...
public class AddCustomerController implements Initializable {
    ...
    public AddCustomerController() {
        this.supplierBO = Startup.getCtx().getBean(SupplierBOImpl.class);
        this.supplier_BankBOImpl = Startup.getCtx().getBean(Supplier_BankBOImpl.class);
        this.branchBO = Startup.getCtx().getBean(BranchBOImpl.class);
    }
    @Override
